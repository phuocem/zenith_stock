...
class AppTheme {
  ...
  static BoxDecoration cardDecoration({Color? borderColor, double radius = 20}) {
    return BoxDecoration(
      color: cardColor,
  ...
  static BoxDecoration glowDecoration({required Color color, double radius = 20}) {
    return BoxDecoration(
      color: cardColor,
      borderRadius: BorderRadius.circular(radius),
  ...
  static List<BoxShadow> get luxuryShadow => [
    ...
    BoxShadow(color: primaryColor.withOpacity(0.04), blurRadius: 2, offset: const Offset(0, 1)),
  ];
  ...
  static final dark = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        textStyle: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 14, letterSpacing: 1.5),
      ),
    ),
